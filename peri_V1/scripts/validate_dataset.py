...
def main() -> None:
    parser = argparse.ArgumentParser(description="Strict EMOTIC dataset validation and summary.")
    ...
    parser.add_argument("--sample-head", type=int, default=20)
    parser.add_argument("--sample-random", type=int, default=20)
    parser.add_argument("--sample-seed", type=int, default=42)
    parser.add_argument("--output", type=Path, default=PROJECT_ROOT / "outputs" / "validation" / "dataset_summary.json")
